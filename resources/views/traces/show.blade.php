<x-ai-orbit::layout>
    <div class="space-y-6">
        ...
        {{-- Timeline --}}
        @if ($messages->isEmpty())
            <x-ai-orbit::empty-state title="No messages" description="This conversation has no recorded messages to trace." />
        @else
            <div class="relative">
                {{-- Vertical line --}}
                            ...
                            <div class="flex-1 min-w-0">
                                <x-ai-orbit::card padding="p-4">
                                    <div class="flex flex-wrap items-center gap-2 mb-2">
                                        ...
                                        <x-ai-orbit::badge :label="$stepLabel" :color="match($message->role) {
                                            'user' => 'blue',
                                            'system' => 'yellow',
                                            'assistant' => 'green',
                                            'tool' => 'purple',
