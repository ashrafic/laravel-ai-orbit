<div>
    ...
    @if ($breakdown->isNotEmpty())
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <x-ai-orbit::card title="Agent Summary" padding="p-0">
                <div class="divide-y divide-gray-200 dark:divide-gray-800">
                    @foreach ($breakdown as $item)
                        ...
                        <div class="flex items-center justify-between px-4 py-3">
                            <div>
                                <p class="text-sm font-medium text-gray-700 dark:text-gray-300">{{ $shortName }}</p>
                                <p class="text-xs text-gray-500 dark:text-gray-400">{{ $item->message_count }} messages</p>
                            </div>
                            <div class="text-right">
                                <p class="text-sm font-semibold text-gray-900 dark:text-gray-100">{{ number_format($total) }}</p>
                                <p class="text-xs text-gray-500 dark:text-gray-400">
                                    <span class="text-purple-500">{{ number_format($item->input_tokens) }} in</span>
                                    <span class="mx-1">&middot;</span>
                                    <span class="text-orange-500">{{ number_format($item->output_tokens) }} out</span>
                                </p>
                            </div>
                        </div>
                    @endforeach
                    ...
                    new Chart(ctx, {
                        ...
                        data: {
                            ...
                            datasets: [{
                                ...
                                backgroundColor: ['#6366f1', '#818cf8', '#a5b4fc', '#c7d2fe', '#e0e7ff', '#8b5cf6', '#a78bfa'],
                                borderColor: '#1f2937',
                                borderWidth: 2,
                            }]
                        },
